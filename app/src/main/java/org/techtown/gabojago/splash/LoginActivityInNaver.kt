...
//
//class LoginActivityInNaver :AppCompatActivity() {
//
...
//            startActivity(Intent(this@LoginActivityInNaver, MainActivity::class.java))
//            finish()
//        }
//    }
//
...
//                Toast.makeText(baseContext,"Login Success", Toast.LENGTH_SHORT).show()
//                var intent = Intent(this@LoginActivityInNaver, MainActivity::class.java)
